                ...
                <div className="row">
                    ...
                    <div className="col-md-3 col-sm-4 col-xs-12">
                        ...
                        <ul className="instragram">
                            <li><img src="/asset/images/insta01.jpg" alt="ins" /></li>
                            <li><img src="/asset/images/insta02.jpg" alt="ins" /></li>
                            <li><img src="/asset/images/insta03.jpg" alt="ins" /></li>
                            <li><img src="/asset/images/insta04.jpg" alt="ins" /></li>
                            <li><img src="/asset/images/insta05.jpg" alt="ins" /></li>
                            <li><img src="/asset/images/insta06.jpg" alt ="ins"/></li>
                        </ul>
                    </div>
                </div>
